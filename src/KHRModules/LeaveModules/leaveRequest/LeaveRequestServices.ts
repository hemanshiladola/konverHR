...
export const getLeaveRequests = async () => {
  ...
  return await Instance.get(`/api/get/leave_requests?user_id=${user_id}`);
};
...
export const createLeaveRequest = async (data: any) => {
  ...
  return await Instance.post(
    `/api/create/leave_request?user_id=${user_id}`,
    data,
  );
};
...
export const updateLeaveRequest = async (id: number, data: any) => {
  ...
  return await Instance.put(
    `/api/update/leave_request/${id}?user_id=${user_id}`,
    data,
  );
};
...
export const deleteLeaveRequest = async (id: number) => {
  ...
  return await Instance.delete(
    `/api/delete/leave_request/${id}?user_id=${user_id}`,
  );
};
