...
const AddEditEmployeeCalendarsKHRModal: React.FC<Props> = ({
  ...
  const validate = () => {
    ...
    // Validate End Time is after Start Time if both exist
    if (startTime && endTime) {
      const tempStart = dayjs()
        .hour(startTime.hour())
  ...
  return (
    <Modal show={show} onHide={handleClose} centered id="add_event_modal">
          ...
          <div className="modal-body">
            <div className="row">
              ...
              <div className="col-12 mb-3">
                <label
                  className={`form-label ${isSubmitted && errors.name ? "text-danger fw-bold" : ""}`}
                >
              ...
              <div className="col-12 mb-3">
                <label
                  className={`form-label ${isSubmitted && errors.eventDate ? "text-danger fw-bold" : ""}`}
                >
                ...
                <div className="input-icon-end position-relative">
                  <DatePicker
                    ...
                    status={
                      isSubmitted && errors.eventDate ? "error" : undefined
                    }
                    format="DD-MM-YYYY"
                    value={eventDate}
                    onChange={(date) => {
                  ...
                  <span className="input-icon-addon">
                    <i
                      className={`ti ti-calendar ${isSubmitted && errors.eventDate ? "text-danger" : "text-gray-7"}`}
                    />
                  </span>
                </div>
                {isSubmitted && errors.eventDate && (
              ...
              <div className="col-md-6 mb-3">
                <label
                  className={`form-label ${isSubmitted && errors.startTime ? "text-danger fw-bold" : ""}`}
                >
                ...
                <div className="input-icon-end position-relative">
                  <TimePicker
                    ...
                    style={{ display: "flex", alignItems: "center" }}
                    status={
                      isSubmitted && errors.startTime ? "error" : undefined
                    }
                    format="h:mm A"
                    use12Hours
                    value={startTime}
                  ...
                  <span className="input-icon-addon">
                    <i
                      className={`ti ti-clock ${isSubmitted && errors.startTime ? "text-danger" : "text-gray-7"}`}
                    />
                  </span>
                </div>
              ...
              <div className="col-md-6 mb-3">
                <label
                  className={`form-label ${isSubmitted && errors.endTime ? "text-danger fw-bold" : ""}`}
                >
                ...
                <div className="input-icon-end position-relative">
                  <TimePicker
                    className="form-control w-100"
                    style={{ display: "flex", alignItems: "center" }}
                    status={isSubmitted && errors.endTime ? "error" : undefined}
                    format="h:mm A"
                    use12Hours
                    value={endTime}
                    onChange={(time) => {
                  ...
                  <span className="input-icon-addon">
                    <i
                      className={`ti ti-clock ${isSubmitted && errors.endTime ? "text-danger" : "text-gray-7"}`}
                    />
                  </span>
                </div>
