                ...
                <div className="d-flex gap-3">
                  ...
                  {groupBy === "is_leave" && (
                    <small className="text-info">
                      ...
                      Leave Types:{" "}
                      <strong>
                        {group.items.filter((item) => item.is_leave).length}
                      </strong>
                    </small>
                  )}
                  {groupBy === "is_unforeseen" && (
                    <small className="text-warning">
                      ...
                      <strong>
                        {
                          group.items.filter((item) => item.is_unforeseen)
                            .length
                        }
                      </strong>
                    </small>
                  ...
                  <small className="text-secondary">
                    ...
                    Sample:{" "}
                    <strong>
                      {group.items[0]?.name.substring(0, 12)}
                      {group.items[0]?.name.length > 12 ? "..." : ""}
                    </strong>
                  </small>
                </div>
              </div>
                ...
                {groupBy !== "none" && (
                  <div className="alert alert-info mb-3 d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <span className="ms-2">
                        ({groupedData.length} groups, {data.length} total entry
                        types)
                      </span>
                    </div>
