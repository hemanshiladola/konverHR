...
const ClientList = () => {
  ...
  const renderClientRow = useCallback(
    (item: ClientRecord, _index: number, style: React.CSSProperties) => (
      <div style={style} key={item.key} className="virtual-list-row">
  ...
  const virtualList = useMemo(
    () => (
      <VirtualList
        ...
        itemHeight={72} // Approximate row height for client rows
