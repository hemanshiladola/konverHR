...
// Define a type-safe interface for contact messages
...
const ContactMessages = () => {
  const data: ContactMessage[] = contactMessagesData;
  const columns = [
    {
      title: "ID",
      dataIndex: "id",
      render: (_text: string, record: ContactMessage, _index: number) => (
    ...
    },
    {
      title: "Name",
      dataIndex: "name",
      render: (_text: string, record: ContactMessage) => (
      ...
      sorter: (a: ContactMessage, b: ContactMessage) => a.name.length - b.name.length,
    },
    {
      title: "Phone",
      dataIndex: "phone",
      sorter: (a: ContactMessage, b: ContactMessage) => a.phone.length - b.phone.length,
    },
    {
      title: "Email",
      dataIndex: "email",
      sorter: (a: ContactMessage, b: ContactMessage) => a.email.length - b.email.length,
    },
    {
      title: "Message",
      dataIndex: "message",
      sorter: (a: ContactMessage, b: ContactMessage) => a.message.length - b.message.length,
    },
    {
      title: "Date",
      dataIndex: "date",
      sorter: (a: ContactMessage, b: ContactMessage) => a.date.length - b.date.length,
    },
    {
      title: "Action",
      dataIndex: "action",
