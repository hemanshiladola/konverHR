  ...
  const columns = [
    {
      ...
      sorter: (a: ResignationData, b: ResignationData) =>
        a.Resigning_Employee.length - b.Resigning_Employee.length,
    },
    {
      title: "Department",
    ...
    },
    {
      ...
      dataIndex: "Reason",
      sorter: (a: ResignationData, b: ResignationData) =>
        a.Reason.length - b.Reason.length,
    },
    {
      title: "Notice Date",
      dataIndex: "Notice_Date",
      sorter: (a: ResignationData, b: ResignationData) =>
        a.Notice_Date.length - b.Notice_Date.length,
    },
    {
