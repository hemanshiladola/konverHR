  ...
  const columns = [
    {
      ...
      sorter: (a: PipelineData, b: PipelineData) =>
        a.Pipeline_Name.length - b.Pipeline_Name.length,
    },
    {
      title: "Total_Deal_Value",
      dataIndex: "Total_Deal_Value",
      sorter: (a: PipelineData, b: PipelineData) =>
        a.Total_Deal_Value.length - b.Total_Deal_Value.length,
    },
    {
      title: "No_of_Deals",
      dataIndex: "No_of_Deals",
      sorter: (a: PipelineData, b: PipelineData) =>
        a.No_of_Deals.length - b.No_of_Deals.length,
    },
    {
      title: "Stages",
      dataIndex: "Stages",
