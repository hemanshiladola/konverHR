              ...
              <div className="single-video d-flex">
                  ...
                  <div className={`chat-active-users ${isActive ? "show-active-users" : ""}`}>
                    <div className="video-avatar">
                      <ImageWithBasePath
                        ...
                        className="img-fluid"
                        alt="Joanne Conner profile picture"
                      />
                ...
                >
                    ...
                    <div className="card slime-grp border-0 mb-0">
                      ...
                      <PerfectScrollbar style={{ height: "calc(100vh - 216px)" }}>
                          ...
                          <div className="chat-msg-blk p-0">
                            <div className="chats">
                              <div className="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                <ImageWithBasePath src="assets/img/users/user-01.jpg" alt="user-image" />
                              </div>
                            ...
                            <div className="chats chats-right">
                              ...
                              <div className="avatar avatar-md avatar-rounded flex-shrink-0 ms-2">
                                <ImageWithBasePath src="assets/img/users/user-02.jpg" alt="user-image" />
                              </div>
                            </div>
                            <div className="chats">
                              <div className="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
