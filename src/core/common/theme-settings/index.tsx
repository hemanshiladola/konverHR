                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        <input
                          ...
                          checked={
                            dataLayout === "horizontal-single" ? true : false
                          }
                          onChange={() =>
                            handleLayoutChange("horizontal-single")
                          }
                        />
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        <input
                          ...
                          checked={
                            dataLayout === "horizontal-overlay" ? true : false
                          }
                          onChange={() =>
                            handleLayoutChange("horizontal-overlay")
                          }
                        />
                        <label htmlFor="horizontal-overlayLayout">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/overlay.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        <input
                          ...
                          checked={
                            dataLayout === "horizontal-sidemenu" ? true : false
                          }
                          onChange={() =>
                            handleLayoutChange("horizontal-sidemenu")
                          }
                        />
                        <label htmlFor="horizontal-sidemenuLayout">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/menu-aside.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="stackedLayout">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/stacked.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="modernLayout">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/modern.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="transparentLayout">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/transparent.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="borderedCard">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/bordered.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="borderlessCard">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/borderless.svg"
                              alt="img"
                            />
                          </span>
                    ...
                    <div className="col-4">
                      <div className="theme-layout mb-3">
                        ...
                        <label htmlFor="shadowCard">
                          <span className="d-block mb-2 layout-img">
                            <ImageWithBasePath
                              src="assets/img/theme/shadow.svg"
                              alt="img"
                            />
                          </span>
              ...
              >
                <div className="accordion-body">
                  <div className="d-flex align-items-center">
                    ...
                    <div
                      className={`theme-colorselect position-relative m-1 mt-0 ${dataSidebar === "all" ? "active" : ""}`}
              ...
              >
                <div className="accordion-body pb-1">
                  <div className="d-flex align-items-center flex-wrap">
                    ...
                    <div
                      className={`theme-colorselect position-relative mb-3 mt-0 ${dataTopBar === "all" ? "active" : ""}`}
                ...
                <div className="accordion-body">
                  ...
                  <div className="d-flex align-items-center">
                    <div className="theme-colorselect m-1 me-3">
                      ...
                      />
                      <label
                        htmlFor="whiteTopbarcolor"
                        className="white-topbar"
                      />
                    </div>
                    <div className="theme-colorselect m-1 me-3">
                      <input
                    ...
                    <div className="theme-colorselect m-1 me-3">
                      <input
                        ...
                        value="blackpearl"
                        checked={
                          dataTopBarColor === "blackpearl" ? true : false
                        }
                    ...
                    <div
                      className={`theme-colorselect position-relative m-1 mt-0 ${dataTopBarColor === "all" ? "active" : ""}`}
                      onClick={() => handleTopBarColorChange2("all")}
                    >
                      <div className="select-color position-absolute">
                        <i className="ti ti-palette"></i>
                      </div>
              ...
              >
                <div className="accordion-body pb-2">
                  <div className="d-flex align-items-center flex-wrap">
                    ...
                    <div
                      className={`theme-colorselect select-theme-color position-relative mb-2 ${dataColor === "all" ? "active" : ""}`}
